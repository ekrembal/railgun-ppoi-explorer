      ...
      {results.map(result =>
        Object.entries(result.poisPerList).map(([blindedCommitment, list]) => (
          <div
            ...
            className="text-clip w-full h-auto mb-4 bg-white rounded-lg shadow"
          >
            <div className="text-clip flex flex-row p-4 border-b border-zinc-400 border-opacity-50 px-[50px] py-[25px]">
              ...
              <div className="text-lg font-normal truncate">{result.txid}</div>
            </div>
